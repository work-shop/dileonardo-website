<section class="block thought-intro single-intro <?php if( !get_field('remove_section_bottom_padding') ) { ?> padded-less-bottom <?php } ?> <?php if( !get_field('show_hero') ) { ?> no-hero <?php } ?>" id="single-intro">
